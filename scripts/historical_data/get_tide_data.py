...
def main():
    ...
    for site in wq_sites:
        ...
        entero_data_file = os.path.join(options.entero_data_dir, "{site}.csv".format(site=site.name))
        ...
        for station in stations:
            tide_data_file = os.path.join(data_directory, "{station}.csv".format(station=station))
